...
<COMPILER_DIRECTIVE> {
	[^n\}]+				{}
	\n						{ addToken(start,zzStartRead-1, Token.PREPROCESSOR); addNullToken(); return firstToken; }
	{MLCEnd}					{ yybegin(YYINITIAL); addToken(start,zzStartRead, Token.PREPROCESSOR); }
	<<EOF>>					{ addToken(start,zzStartRead-1, Token.PREPROCESSOR); addNullToken(); return firstToken; }
}

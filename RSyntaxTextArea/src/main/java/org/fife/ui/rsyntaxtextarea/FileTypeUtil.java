...
public final class FileTypeUtil implements SyntaxConstants {
    ...
    public static Pattern fileFilterToPattern(String fileFilter) {
        ...
        int flags = RSyntaxUtilities.isOsCaseSensitive() ? 0 :
     ...
     *         be determined.
     */
    private static String guessContentTypeImpl(String fileName,
									   Map<String, List<String>> filters) {
	...
	private static void initFiltersImpl(Map<String, List<String>> map,
								String syntax, String... filters) {
    ...
    private void initializeFilters() {
        ...
        initFiltersImpl(map, SYNTAX_STYLE_LISP, "*.cl", "*.clisp", "*.el", "*.l", "*.lisp",
            "*.lsp", "*.ml");

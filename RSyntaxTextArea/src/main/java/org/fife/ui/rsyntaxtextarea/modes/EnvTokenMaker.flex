...
UnquotedValueChar			= ([^ \t\n\"\'#])
UnquotedValue				= ({UnquotedValueChar}+)
...
<YYINITIAL> {
	...
	"export"/{Whitespace}		{ addToken(TokenTypes.RESERVED_WORD); }
	{Key}						{ addToken(TokenTypes.VARIABLE); }
...
<VALUE> {
	...
	{UnquotedValue}				{ addToken(TokenTypes.IDENTIFIER); }
	\n |
	<<EOF>>						{ addNullToken(); return firstToken; }
}
